	...
	function validateSession(){
		...
		if(role==4 || role==5){
			if(status_id==1 && (id1==null || id1.equals("") || id1.equals("null") || id1.equals("NULL"))){
                ...
                if(!DBConnector.getQueryResult("select * from account where account_id="+accountFrom).next()){
                    response.sendRedirect("AuthError.jsp");
                    return;
                }
                
                if(!DBConnector.getQueryResult("select * from account where account_id="+accountTo).next()){
                    response.sendRedirect("AuthError.jsp");
                    return;
                }
